...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs, R.styleable.__picker_SmoothCheckBox);
        int tickColor = ta.getColor(R.styleable.__picker_SmoothCheckBox___picker_color_tick, COLOR_TICK);
        mAnimDuration = ta.getInt(R.styleable.__picker_SmoothCheckBox___picker_duration, DEF_ANIM_DURATION);
        mFloorColor = ta.getColor(R.styleable.__picker_SmoothCheckBox___picker_color_unchecked_stroke, COLOR_FLOOR_UNCHECKED);
        mCheckedColor = ta.getColor(R.styleable.__picker_SmoothCheckBox___picker_color_checked, COLOR_CHECKED);
        mUnCheckedColor = ta.getColor(R.styleable.__picker_SmoothCheckBox___picker_color_unchecked, COLOR_UNCHECKED);
        mStrokeWidth = ta.getDimensionPixelSize(R.styleable.__picker_SmoothCheckBox___picker_stroke_width, CompatUtils.dp2px(getContext(), 0));
        ta.recycle();
    ...
    private ValueAnimator mFloorAnimator;
    ...
    private void startCheckedAnimation() {
        ...
        mAnimator.setDuration(mAnimDuration / 3 * 2);
        ...
        mFloorAnimator = ValueAnimator.ofFloat(1.0f, 0.8f, 1.0f);
        mFloorAnimator.setDuration(mAnimDuration);
        mFloorAnimator.setInterpolator(new LinearInterpolator());
        mFloorAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            @Override
            public void onAnimationUpdate(ValueAnimator animation) {
