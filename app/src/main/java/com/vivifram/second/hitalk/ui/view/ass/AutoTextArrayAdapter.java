package com.vivifram.second.hitalk.ui.view.ass;
/*
...
public class AutoTextArrayAdapter<T> extends BaseAdapter implements Filterable {
     ...
     */
    public AutoTextArrayAdapter(Context context, int textViewResourceId) {
     ...
     */
    public AutoTextArrayAdapter(Context context, int resource, int textViewResourceId) {
     ...
     */
    public AutoTextArrayAdapter(Context context, int textViewResourceId, T[] objects) {
     ...
     *            The objects to represent in the ListView.
     */
    public AutoTextArrayAdapter(Context context, int resource, int textViewResourceId, T[] objects) {
     ...
     *            The objects to represent in the ListView.
     */
    public AutoTextArrayAdapter(Context context, int textViewResourceId, List<T> objects) {
     ...
     *            The objects to represent in the ListView.
     */
    public AutoTextArrayAdapter(Context context, int resource, int textViewResourceId, List<T> objects) {
