...
public class EmojiconScrollTabBar extends RelativeLayout{
    ...
    private OnScrollTabBarItemClickListener itemClickListener;
    ...
    private void init(Context context, AttributeSet attrs){
        ...
        LayoutInflater.from(context).inflate(R.layout.emojicon_tab_bar_layout, this);
    ...
    public void addTab(int icon){
        View tabView = View.inflate(context, R.layout.scroll_tab_item_layout, null);
        ImageView imageView = (ImageView) tabView.findViewById(R.id.iv_icon);
        imageView.setImageResource(icon);
        LinearLayout.LayoutParams imgParams = new LinearLayout.LayoutParams(DisplayUtil.dip2px(context, tabWidth), LayoutParams.MATCH_PARENT);
    ...
    public void setTabBarItemClickListener(OnScrollTabBarItemClickListener itemClickListener){
        this.itemClickListener = itemClickListener;
    }


    public interface OnScrollTabBarItemClickListener{
