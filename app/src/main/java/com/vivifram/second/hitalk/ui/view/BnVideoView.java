...
import com.zuowei.utils.videolist.VideoListGlideModule;
import com.zuowei.utils.videolist.items.ListItem;
import com.zuowei.utils.videolist.model.VideoLoadMvpView;
import com.zuowei.utils.videolist.target.VideoLoadTarget;
import com.zuowei.utils.videolist.target.VideoProgressTarget;
 ...
 */
public class BnVideoView extends LinearLayout implements VideoLoadMvpView, ListItem {
    ...
    public BnVideoView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void init() {
        inflate(getContext(), R.layout.bn_video_layout, this);
