...
public class BnMovementMethod extends BaseMovementMethod {
    public final String TAG = TagUtil.makeTag(BnMovementMethod.class);
    ...
    public BnMovementMethod(){
        this.textViewBgColor = HiTalkApplication.mAppContext.getResources().getColor(DEFAULT_COLOR_ID);
        this.clickableSpanBgClor = HiTalkApplication.mAppContext.getResources().getColor(DEFAULT_CLICKABLEA_COLOR_ID);
    }
     ...
     */
    public BnMovementMethod(int clickableSpanBgClor){
     ...
     */
    public BnMovementMethod(int clickableSpanBgClor, int textViewBgColor){
