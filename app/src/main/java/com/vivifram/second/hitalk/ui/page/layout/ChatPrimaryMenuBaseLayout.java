...
public abstract class ChatPrimaryMenuBaseLayout extends RelativeLayout{
    protected ChatPrimaryMenuListener listener;
    protected Activity activity;
    protected InputMethodManager inputManager;

    public ChatPrimaryMenuBaseLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(context);
    }

    public ChatPrimaryMenuBaseLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public ChatPrimaryMenuBaseLayout(Context context) {
        super(context);
        init(context);
    }
