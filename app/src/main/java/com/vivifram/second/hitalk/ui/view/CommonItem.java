...
public class CommonItem extends FrameLayout {
	...
	public void setSummaryImg(Drawable drawable,int width,int height) {
		RelativeLayout.LayoutParams layoutParams = (RelativeLayout.LayoutParams) mSummaryImg.getLayoutParams();
		layoutParams.width = width;
		layoutParams.height = height;
		mSummaryImg.setLayoutParams(layoutParams);
		mSummaryImg.setImageDrawable(drawable);
		mSummaryImg.setAdjustViewBounds(true);
	}
