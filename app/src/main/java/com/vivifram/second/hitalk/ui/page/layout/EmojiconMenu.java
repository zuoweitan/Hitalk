 ...
 */
public class EmojiconMenu extends EmojiconMenuBaseLayout {
    ...
    private List<EmojiconGroupEntity> emojiconGroupList = new ArrayList<>();
    ...
    public void init(List<EmojiconGroupEntity> groupEntities){
        ...
        tabBar.setTabBarItemClickListener(new EmojiconScrollTabBar.OnScrollTabBarItemClickListener() {
            @Override
