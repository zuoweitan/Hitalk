...
public class EmojiconIndicatorView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        dotHeight = DisplayUtil.dip2px(context, dotHeight);
        selectedBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.dot_emojicon_selected);
        unselectedBitmap = BitmapFactory.decodeResource(context.getResources(), R.drawable.dot_emojicon_unselected);
