...
import com.vivifram.second.hitalk.ui.spannable.BnMovementMethod;
...
public class CommentListView extends LinearLayout {
    ...
    private View getView(final int position){
        ...
        View convertView = layoutInflater.inflate(R.layout.bn_comment_layout, null, false);

        TextView commentTv = (TextView) convertView.findViewById(R.id.commentTv);
        final BnMovementMethod bnMovementMethod = new BnMovementMethod(itemSelectorColor, itemSelectorColor);
        ...
        commentTv.setMovementMethod(bnMovementMethod);
        commentTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (bnMovementMethod.isPassToTv()) {
    ...
    private SpannableString setClickableSpan(final String textStr, final String id) {
        ...
        subjectSpanText.setSpan(new SpannableClickable(itemColor){
                                    ...
                                    public void onClick(View widget) {
                                        Toast.makeText(HiTalkApplication.mAppContext, textStr + " &id = " + id, Toast.LENGTH_SHORT).show();
                                    }
