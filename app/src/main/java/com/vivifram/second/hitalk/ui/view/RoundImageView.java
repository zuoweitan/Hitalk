...
public class RoundImageView extends ImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawRoundRect(roundRect,6,6,mBitmapPaint);

        canvas.drawCircle(getWidth() / 2, getHeight() / 2, mDrawableRadius, mBitmapPaint);
        if (mBorderWidth != 0) {
            canvas.drawRoundRect(roundRect,6,6,mBorderPaint);
        }
    }
    ...
    public void setBackgroundColor(int color) {
    	CircleColorDrawable drawable = new CircleColorDrawable(getContext(),color);
        mBitmap = null;
    ...
    private void setup() {
        ...
        roundRect.left = mBorderWidth;
        roundRect.top = mBorderWidth;
        roundRect.right = getWidth() - mBorderWidth;
        roundRect.bottom = getHeight() - mBorderWidth;

        borderRect.left = 0;
        borderRect.top = 0;
        borderRect.right = getWidth();
        borderRect.bottom = getHeight();
