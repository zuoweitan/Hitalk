...
public class AvatarView extends ImageView {
    ...
    public AvatarView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            mBorderWidth = a.getDimensionPixelSize(R.styleable.AvatarView_avatar_border_width, mBorderWidth);
            mBorderColor = a.getColor(R.styleable.AvatarView_avatar_border_color, mBorderColor);

            mShadowWidth = a.getDimensionPixelSize(R.styleable.AvatarView_avatar_shadow_width, mShadowWidth);
            mShadowColor = a.getColor(R.styleable.AvatarView_avatar_shadow_color, mShadowColor);
        } finally {
            a.recycle();
        }
    ...
    private void initBitmap() {
        ...
        mBitmapRadius = Math.min(mBitmapRect.width() / 2, mBitmapRect.height() / 2) - 2;
        updateShaderMatrix();
    }
