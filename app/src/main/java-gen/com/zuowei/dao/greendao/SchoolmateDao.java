...
public class SchoolmateDao extends AbstractDao<Schoolmate, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property ReleatedId = new Property(1, String.class, "releatedId", false, "RELEATED_ID");
        public final static Property FriendState = new Property(2, Integer.class, "friendState", false, "FRIEND_STATE");
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"SCHOOLMATE\" (" + //
                ...
                "\"RELEATED_ID\" TEXT NOT NULL ," + // 1: releatedId
                "\"FRIEND_STATE\" INTEGER," + // 2: friendState
    ...
    public Schoolmate readEntity(Cursor cursor, int offset) {
        Schoolmate entity = new Schoolmate( //
            ...
            cursor.getString(offset + 1), // releatedId
            cursor.isNull(offset + 2) ? null : cursor.getInt(offset + 2), // friendState
